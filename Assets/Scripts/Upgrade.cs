...
public class Upgrade 
{
    ...
    public static readonly Upgrade ShieldRegen = new Upgrade(7, "Shield Regen", 4000, "Sprites/Shield", 100, 100);
    public static readonly Upgrade Magnet2 = new Upgrade(8, "Magnet 2.0", 6000, "Sprites/Magnet", 100, 100);
    public static readonly Upgrade AngledLasers = new Upgrade(9, "Angled Lasers", 10000, "Sprites/Laser", 8, 100);
